...
export class AuthController {
    ...
    public async login(req: Request, res: Response) {
        try {
            ...
            res.status(400).json({ message: "Login failed: ", "cause": "Username and/or password invalid." });
        }
    }
    ...
    public async register(req: Request, res: Response) {
        try {
            ...
            res.status(400).json({ message: "User registration failed: ", "cause": "Username and/or password invalid." });
        }
    }
